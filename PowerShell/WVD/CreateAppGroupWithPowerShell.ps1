...
Get-AzWvdHostPool -ResourceGroupName Lab1HPRG -HostPoolName Lab1HP
...
New-AzRoleAssignment -SignInName "MarketingUser1@ciraltoslab.com" `
...
New-AzRoleAssignment -ObjectId "046485e0-6645-4d15-a09f-7162e7441b68" `
    -RoleDefinitionName "Desktop Virtualization User" `
    -ResourceName "PowerShellLabAG" `
    -ResourceGroupName "Lab1HPRG" `
    -ResourceType "Microsoft.DesktopVirtualization/applicationGroups"
